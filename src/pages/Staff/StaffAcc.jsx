                ...
                <div className="bg-white p-4 my-2 rounded-md shadow-md">
                    <div className="md:grid grid-cols-4 gap-4">
                        <div className="bg-[#00B0FF] w-auto rounded-md flex justify-between px-4 py-6">
                            <div className="flex">
                                <img src={StaffImg} alt="" className="rounded-xl h-16 w-auto" />
                                <div className="">
                                    <p className="pl-2 text-white pt-2 uppercase font-semibold text-xl">Staff</p>
                                    <p className="pl-2 text-white text-sm">Total Staff</p>
                                </div>
                            </div>
                            <div className="">
                        ...
                        <div className="bg-[#00B0FF] w-auto rounded-md flex justify-between px-4 py-6">
                            ...
                            <BsPlusSquareFill className="h-16 w-16 text-white fill-white" />
                                <div className="">
                                    ...
                                    <p className="pl-2 text-white text-sm">Staff</p>
                                </div>
                            </div>
                        </div>
